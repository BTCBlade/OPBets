...
Revision ID: e6de58b278ff
Revises: 
Create Date: 2021-08-11 22:03:16.275854
...
def upgrade():
    ...
    sa.Column('lower_cancel_odds', sa.Text(), nullable=True),
    sa.Column('higher_cancel_odds', sa.Text(), nullable=True),
